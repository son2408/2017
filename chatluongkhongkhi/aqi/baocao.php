...
<body>
  ...
  if(isset($_GET['username'])){
    $tentaikhoan = $_GET['username'];
	 ...
	 ?>
	<form action="baocao_main.php?username=<?php echo $tentaikhoan ?>&filename=<?php if(isset($_GET['filename'])){
            echo $_GET['filename'];
            } ?>" method="POST">
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						<div class="modal-header">
							<div class="row">
								<div class="col-md-12">
									<a  class="close" href="dashboard-aqi.php?username=<?php echo $tentaikhoan ?>">&times;</a>
						...
						<div class="modal-footer">
							...
							<a class="btn btn-default" href="dashboard-aqi.php?username=<?php echo $tentaikhoan ?>"> Đóng</a>
						</div> <!-- end footer -->
